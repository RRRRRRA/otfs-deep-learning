...
try:
    f = open('results_map_ce_mse.pkl', 'rb')
    ...
    for optimizer_name in optimizer_names:
        for dropout_rate in dropout_rates:
            ...
            if k in results_map_ce_mse:
                ...
                continue
            results_map_ce_mse[k] = train_model_ce_mse(train_loader_ce_mse, test_loader_ce_mse, epochs = EPOCHS,
                                                lr = lr, optimizer_name = optimizer_name, dropout_rate = dropout_rate, verbose = True)


            f = open('results_map_ce_mse.pkl', 'wb')
